...
public enum CodigosDivisas {
    ...
    SLE("SLE", "Sierra Leonean Leone (new leone)"),
    SLL("SLL", "Sierra Leonean leone (old leone)"),
    ...
    CodigosDivisas(String codigo, String nombre){
        this.codigo = codigo;
        this.nombre = nombre;
    }
    ...
    public static CodigosDivisas obtenerPorCodigo(String codigo) {
        for (CodigosDivisas divisa : values()) {
            if (divisa.codigo.equalsIgnoreCase(codigo)) {
                return divisa;
            }
        }
        return null;
